...
\caption{Precision and recall of splits made by a BPE tokeniser in words with typos vs.\ without.}
\label{tab:typos}
\end{table}
...
\end{tabular}}
\caption{Evaluation of BPE-knockout on bound and free morpheme boundaries in e-Lex.}
