...
\usepackage[bidi=default, dutch]{babel}  % Change your language here. (The bidi=default makes it so that \texthebrew is not printed in reverse.)
...
\begin{document}
	...
	\backmatter
	% The following line (when uncommented) continues \mainmatter numbering but in Roman style (since \backmatter doesn't reset the page number or change page style...) https://tex.stackexchange.com/q/56131/203081
	%\renewcommand{\thepage}{\alph{page}}
	% The following line resets the page number starting from a. https://tex.stackexchange.com/a/56133/203081
	\pagenumbering{alph}
